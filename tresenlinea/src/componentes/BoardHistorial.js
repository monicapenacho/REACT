...
export default function BoardHistorial({classname, classtext, xIsNext, squares, onPlay}) {
    ...
    function handleClick(i) {
        ...
        if (CalculateWinner(squares) || squares[i]) {                  //control vacíos O GANADOR. No se puede modificar si está lleno O control declarar al ganador
        //VACIO
        ...
        onPlay (nextSquares);  //Reemplazar las dos llamadas anteriores por llamada a su nueva función onPlay para que el componente Game pueda actualizar el componente Board cuando el usuario hace clic en un cuadrado:
    }
