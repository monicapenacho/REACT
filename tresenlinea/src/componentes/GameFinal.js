...
export default function Game() {
    ...
    const xIsNext = currentMove % 2 === 0; // Cambia Game para que no almacene xIsNext como una variable de estado separada y en su lugar lo calcule basándose en el currentMove:
